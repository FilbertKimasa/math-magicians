...
function Buttons() {
  const btnClick = (btnValue) => btnValue;
  return (
    <>
      ...
      <button type="button" className="grid-box left" onClick={btnClick('÷')}>
        ÷
      </button>
      ...
      <button type="button" className="grid-box left" onClick={btnClick('x')}>
        x
      </button>
